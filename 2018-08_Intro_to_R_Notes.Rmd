...
subtitle: Adapted and shortened from an R-Ladies useR! 2018 R-Curious workshop
title: "Intro to R"
---
...
Assign the number 5 to an *object* `x` with arrow `<-`.  
...
This will open an `Untitled1` template.  

--

Save your document, you have given your document a title, not saved it!  

--

Now we will `knit` our document to an HTML document using the `knit` button or **control + shift + k**.
